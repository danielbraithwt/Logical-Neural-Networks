...
for i in range(num):
    ...
    with tf.Graph().as_default():
        res = MultiOutNN.train_lnn(X_train, Y_train, iterations, num_inputs, layers, num_outputs, sm)

        training_wrong = MultiOutNN.run_lnn(X_train, Y_train, res, num_inputs, layers, num_outputs, sm)
        testing_wrong = MultiOutNN.run_lnn(X_test, Y_test, res, num_inputs, layers, num_outputs, sm)
